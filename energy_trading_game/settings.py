"""
Django settings for energy_trading_game project.
...
SECRET_KEY = 'django-insecure-edgcd&u4#y=b!z@z=@0q_w15=9%v8^x8ro+)^9k%0mkbz_#axu'
...
ROOT_URLCONF = 'energy_trading_game.urls'
